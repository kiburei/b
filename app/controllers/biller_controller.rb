class BillerController < ApplicationController
  ...
  def push
    ...
    a = RestClient.post 'http://processor.nouveta.co.ke/index.php', {PhoneNumber: mpesa_number, paymentMode: 'Mpesa', AccountReference: 'Biller', Amount: amount, api_key: "a94a8fe5ccb19ba61c4c0873d391e987982fbbd3"}
